...
- `MobiFlow_Agent`
  LangGraph-based Agent runtime for natural-language task intake, dynamic phase planning, validated step policy, governed execution, structured verification, recovery, task memory, trace export, and scenario regression reporting.
...
1. Agent decision layer
   Responsible for task interpretation, dynamic phase planning, dynamic step routing, bounded model decisions, structured verification, recovery, memory-enhanced execution, and exportable runtime evidence.
...
- The Agent subproject currently focuses on bounded mobile experiment workflows, simulated scenario regression, and execution traceability rather than large-scale real-device benchmarking.
